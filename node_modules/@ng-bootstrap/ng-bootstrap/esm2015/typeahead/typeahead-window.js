...
function NgbTypeaheadWindow_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const result_r269 = ctx.result;
    const term_r270 = ctx.term;
    const formatter_r271 = ctx.formatter;
    ɵngcc0.ɵɵproperty("result", formatter_r271(result_r269))("term", term_r270);
} }
...
function NgbTypeaheadWindow_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("mouseenter", function NgbTypeaheadWindow_ng_template_2_Template_button_mouseenter_0_listener() { ɵngcc0.ɵɵrestoreView(_r276); const idx_r273 = ctx.index; const ctx_r275 = ɵngcc0.ɵɵnextContext(); return ctx_r275.markActive(idx_r273); })("click", function NgbTypeaheadWindow_ng_template_2_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r276); const result_r272 = ctx.$implicit; const ctx_r277 = ɵngcc0.ɵɵnextContext(); return ctx_r277.select(result_r272); });
    ɵngcc0.ɵɵtemplate(1, NgbTypeaheadWindow_ng_template_2_ng_template_1_Template, 0, 0, "ng-template", 4);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const result_r272 = ctx.$implicit;
    const idx_r273 = ctx.index;
    const ctx_r268 = ɵngcc0.ɵɵnextContext();
    const _r266 = ɵngcc0.ɵɵreference(1);
    ɵngcc0.ɵɵclassProp("active", idx_r273 === ctx_r268.activeIdx);
    ɵngcc0.ɵɵproperty("id", ctx_r268.id + "-" + idx_r273);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r268.resultTemplate || _r266)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(5, _c0, result_r272, ctx_r268.term, ctx_r268.formatter));
} }
