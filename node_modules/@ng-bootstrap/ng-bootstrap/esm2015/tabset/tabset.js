...
function NgbTabset_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NgbTabset_li_1_Template_a_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r215); const tab_r212 = ctx.$implicit; const ctx_r214 = ɵngcc0.ɵɵnextContext(); ctx_r214.select(tab_r212.id); return $event.preventDefault(); });
    ɵngcc0.ɵɵtext(2);
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("active", tab_r212.id === ctx_r210.activeId)("disabled", tab_r212.disabled);
    ɵngcc0.ɵɵproperty("id", tab_r212.id);
    ɵngcc0.ɵɵattribute("tabindex", tab_r212.disabled ? "-1" : undefined)("aria-controls", !ctx_r210.destroyOnHide || tab_r212.id === ctx_r210.activeId ? tab_r212.id + "-panel" : null)("aria-selected", tab_r212.id === ctx_r210.activeId)("aria-disabled", tab_r212.disabled);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", tab_r212.title, "");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", tab_r212.titleTpl == null ? null : tab_r212.titleTpl.templateRef);
} }
...
function NgbTabset_ng_template_3_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassMapInterpolate1("tab-pane ", tab_r216.id === ctx_r217.activeId ? "active" : null, "");
    ɵngcc0.ɵɵpropertyInterpolate1("id", "", tab_r216.id, "-panel");
    ɵngcc0.ɵɵattribute("aria-labelledby", tab_r216.id);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", tab_r216.contentTpl == null ? null : tab_r216.contentTpl.templateRef);
} }
function NgbTabset_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r211.destroyOnHide || tab_r216.id === ctx_r211.activeId);
} }
let nextId = 0;
/**
