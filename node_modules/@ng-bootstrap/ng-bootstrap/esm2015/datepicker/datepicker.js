...
function NgbDatepicker_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const date_r104 = ctx.date;
    const currentMonth_r105 = ctx.currentMonth;
    const selected_r106 = ctx.selected;
    const disabled_r107 = ctx.disabled;
    const focused_r108 = ctx.focused;
    ɵngcc0.ɵɵproperty("date", date_r104)("currentMonth", currentMonth_r105)("selected", selected_r106)("disabled", disabled_r107)("focused", focused_r108);
} }
function NgbDatepicker_ng_template_2_div_0_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const month_r110 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r112 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate2(" ", ctx_r112.i18n.getMonthFullName(month_r110.number, month_r110.year), " ", ctx_r112.i18n.getYearNumerals(month_r110.year), " ");
} }
function NgbDatepicker_ng_template_2_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    const month_r110 = ctx.$implicit;
    const ctx_r109 = ɵngcc0.ɵɵnextContext(2);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r109.navigation === "none" || ctx_r109.displayMonths > 1 && ctx_r109.navigation === "select");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("month", month_r110.firstDate);
} }
function NgbDatepicker_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r99.model.months);
} }
function NgbDatepicker_ngb_datepicker_navigation_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("navigate", function NgbDatepicker_ngb_datepicker_navigation_5_Template_ngb_datepicker_navigation_navigate_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r115); const ctx_r114 = ɵngcc0.ɵɵnextContext(); return ctx_r114.onNavigateEvent($event); })("select", function NgbDatepicker_ngb_datepicker_navigation_5_Template_ngb_datepicker_navigation_select_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r115); const ctx_r116 = ɵngcc0.ɵɵnextContext(); return ctx_r116.onNavigateDateSelect($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r100 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("date", ctx_r100.model.firstDate)("months", ctx_r100.model.months)("disabled", ctx_r100.model.disabled)("showSelect", ctx_r100.model.navigation === "select")("prevDisabled", ctx_r100.model.prevDisabled)("nextDisabled", ctx_r100.model.nextDisabled)("selectBoxes", ctx_r100.model.selectBoxes);
} }
...
NgbDatepicker.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: NgbDatepicker, selectors: [["ngb-datepicker"]], contentQueries: function NgbDatepicker_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(2);
        ɵngcc0.ɵɵproperty("ngTemplateOutlet", (ctx.contentTemplate == null ? null : ctx.contentTemplate.templateRef) || _r98);
        ɵngcc0.ɵɵadvance(1);
